var data = {
  chatinit: {
    title: [
      "Olá! Bem-vindo ao nosso chat para tirar as suas dúvidas!' &#128075;</span>",
  ...
  preanalise: {
    title: [
      "Por favor, acessa o nosso site para fornecer as seguintes informações para uma pré-análise:",
    ],
    options: [
      "RG",
      "CPF",
  ...
  sedan: {
    title: [
      "Obrigado pela a sua resposta!, Temos algumas opções do modelo a seguir:",
    ],
